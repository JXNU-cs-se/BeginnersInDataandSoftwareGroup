<img width="275" alt="image" src="https://github.com/JXNU-cs-se/BeginnersInDataandSoftwareGroup/assets/2408935/5697d9d4-f681-4694-a622-fad16fd7ebbc">Beginners in soft engineering
...
1. 深度学习
	...
	9. 度学习面试宝典（含数学、机器学习、深度学习、计算机视觉、自然语言处理和SLAM等方向） https://github.com/amusi/Deep-Learning-Interview-Book
	10. NLP-BERT 谷歌自然语言处理模型：BERT-基于pytorch https://github.com/Y1ran/NLP-BERT--ChineseVersion
...
7. 自然语言处理
	...
	6. 斯坦福大学自然语言处理主页  http://www-nlp.stanford.edu
	 7. 分词工具请使用  结巴
https://github.com/fxsjy/jieb ; https://github.com/LiveMirror/jieb
...
10. 强化学习中文教程（蘑菇书），在线阅读地址：https://datawhalechina.github.io/easy-rl/
...
14. 数字孪生  
    ...
    3. 
15. 大模型学习汇总：
   1. 飞书分享： The Document is All You Need！一站式 LLM底层技术原理入门指南  陈敏凯Marco 张辰立 陈敏凯 
