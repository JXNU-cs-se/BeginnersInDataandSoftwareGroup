...
11. https://www.yanweb.top/ 科研工具合集，检索信息门户网站！ 👍🏻👍🏻👍🏻👍🏻👍🏻
...
### 7、一整套超实用论文写作模板  👍🏻👍🏻👍🏻👍🏻👍🏻
====
建议我们数据与软件创新的同学在撰写研究论文时，参考这份写作模板，依据模板给出的每个部分的写作指导，凝练自己要表达的内容。 [一整套超实用论文写作模板.pdf](https://github.com/JXNU-cs-se/BeginnersInDataandSoftwareGroup/blob/main/%E8%B5%84%E6%BA%90%E6%96%87%E6%A1%A3/%E4%B8%80%E6%95%B4%E5%A5%97%E8%B6%85%E5%AE%9E%E7%94%A8%E8%AE%BA%E6%96%87%E5%86%99%E4%BD%9C%E6%A8%A1%E6%9D%BF.pdf) 
...
6. 软件工程
	...
	6. 软件工程必读论文: https://www.aminer.cn/topic/5e7ed98a3357bd9befb4ae17
 	7. 基于深度学习的软件工程方面的综述论文：《Deep Learning-based Software Engineering: Progress, Challenges, and Opportunities》 https://jiangyanjie.github.io/Deep-Learning-Based-Software-Engineering/  重点综述了深度学习在需求工程（Requirements Engineering）、代码生成（Code Generation）、代码搜索（Code Search）、代码摘要（Code Summarization）、软件重构（Software Refactoring）、代码克隆检测（Code Clone Detection）、软件缺陷预测（Software Defect Prediction）、错误查找（Bug Finding）、缺陷定位（Fault Localization）、错误修复（Program Repair）、错误报告管理（Bug Report Management）、开发人员协作（Developer Collaboration）等十二个软件工程任务上的最新进展，目前我们的综述论文已被《SCIENCE CHINA Information Sciences》接收。在撰写过程中，我们发现这方面的新工作还在不断涌现，我们的综述也很难囊括这些不断涌现的新工作。因此，我们开发并维护了一个综述网站（https://jiangyanjie.github.io/Deep-Learning-Based-Software-Engineering/），以便我们在论文发表后继续跟进这方面的最新研究进展。在此，我们诚邀各位老师和同学将与本主题相关的最新论文提交到网站，供同行阅读、参考！
